...
class PlotApp(QMainWindow):
    def __init__(self):
        ...
        topleft_layout.addWidget(self.load_button, 8)
        ...
        tif_layout.addLayout(tif_left_layout, 4)
        tif_layout.addWidget(self.result_tif, 9)
        #tif_layout.addWidget(save_button, 1, alignment=QtCore.Qt.AlignBottom)
