...
daysall=Converter.lunar_month_days
solar11all=Converter.solar_1_1
print(daysall)
print(len(daysall),len(solar11all))
days=Converter.lunar_month_days[2023-Converter.lunar_month_days[0]]
solar11=Converter.solar_1_1[2022-Converter.solar_1_1[0]]
print(days)
print(solar11)
leap = GetBitInt(days, 4, 13)        #leap = GetBitInt(days, 4, 13)
for i in range(0,13):
    print(GetBitInt(days, 1, 12 - i))
print(leap)
y = GetBitInt(solar11, 12, 9)
m = GetBitInt(solar11, 4, 5)
d = GetBitInt(solar11, 5, 0)
