...
so_list=[["L1287"  ,00,36,45.6500,+63,28,57.9],
         ["3c84"   ,03,19,48.1601,+41,30,42.103],
         ["3c459"  ,23,16,35.1925,+04,5,18.2929],
...
fig, ax = plt.subplots()
ax.plot(UTCList, ELList,c='green', linewidth=1,label=so_list[n][0])
